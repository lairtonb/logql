/*
    ...
    $Id: ToUpper.java,v 1.2 2009/10/29 05:11:15 mreddy Exp $
*/
...
public class ToUpper extends SelectFunction implements StringWhereFunction {
	...
	public void convert(byte[] carr, Marker m) {
		for (int i = m.startPos; i < m.endPos; i++) {
			if (carr[i] > _MinValue && carr[i] < _MaxValue) {
				carr[i] -= 32;
			}
		}
	}
