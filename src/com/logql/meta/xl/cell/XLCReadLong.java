/*
    ...
    $Id: XLCReadLong.java,v 1.2 2009/10/29 05:11:18 mreddy Exp $
*/
...
public class XLCReadLong extends XLReadField{
	HSSFFormulaEvaluator  evaluator;
	long value;
	CellReference cref;

	public XLCReadLong(XLFieldMeta meta) {
		super(meta);
		cref = meta.getCref();
	}
		...
		if (row != null) {
			...
			if (cell == null) {
				...
				if (cell.getCellType() == HSSFCell.CELL_TYPE_STRING) {
					...
					HSSFFormulaEvaluator.CellValue cval = evaluator
							.evaluate(cell);
					if (cval.getCellType() == HSSFCell.CELL_TYPE_NUMERIC) {
						value = (long) cval.getNumberValue();
					}
				} else {
